...
cat song1out.valid song2out.valid song2out.train song3out.valid song3out.train song4out.train song4out.valid tangout.valid > $valid1

train2='train2.train'
valid2='valid2.valid'
rm -f $train2 $valid2
cat song2out.train tangout.train | shuf > $train2
cat song2out.valid song1out.valid song1out.train song3out.valid song3out.train song4out.train song4out.valid tangout.valid > $valid2

train3='train3.train'
valid3='valid3.valid'
rm -f $train3 $valid3
cat song3out.train tangout.train | shuf > $train3
cat song3out.valid song2out.valid song2out.train song1out.valid song1out.train song4out.train song4out.valid tangout.valid > $valid3

train4='train4.train'
valid4='valid4.valid'
rm -f $train4 $valid4
cat song4out.train tangout.train | shuf > $train4
cat song4out.valid song2out.valid song2out.train song3out.valid song3out.train song1out.train song1out.valid tangout.valid > $valid4
