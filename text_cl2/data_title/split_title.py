...
if __name__ == "__main__":
    ...
    file1 = './test_1.title'
    with open(file1) as f, open('/home/lr/lijia/poetry/text_cl2/data_title/test1', 'w') as fw:
    ...
    file2 = './test_2.title'
    with open(file2) as f, open('/home/lr/lijia/poetry/text_cl2/data_title/test2', 'w') as fw:
        writer = csv.writer(fw, delimiter='\t')
        for line in f:
            l = line.split('\n')[0] 
            l = l.split('\t')
    ...
    file3 = './test_3.title'
    with open(file3) as f, open('/home/lr/lijia/poetry/text_cl2/data_title/test3', 'w') as fw:
        writer = csv.writer(fw, delimiter='\t')
        for line in f:
            l = line.split('\n')[0] 
            l = l.split('\t')
