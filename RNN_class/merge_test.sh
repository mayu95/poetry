...
train1='data_poetry/train1.train'
valid1='data_poetry/valid1.valid'
rm -f $train1 $valid1
cat data_poetry/rnn_song1out.train data_poetry/rnn_tangout.train | shuf > $train1
cat data_poetry/rnn_song1out.valid data_poetry/rnn_tangout.valid > $valid1
