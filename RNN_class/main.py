...
#  v_builder = VocabBuilder(path_file='data/train.tsv')
v_builder = VocabBuilder(path_file='/home/lr/lijia/poetry/build_data/train1.train')
d_word_index, embed = v_builder.get_word_index(min_sample=args.min_samples)
...
train_loader = TextClassDataLoader('/home/lr/lijia/poetry/build_data/train1.train', d_word_index, batch_size=args.batch_size)
val_loader = TextClassDataLoader('/home/lr/lijia/poetry/build_data/valid1.valid', d_word_index, batch_size=args.batch_size)
